...
ConVar sm_corecfgfile("sm_corecfgfile", "addons\\source2mod\\configs\\core.cfg", 0, "Source2Mod core configuration file");
...
#else
	const char *corecfg = "addons\\source2mod\\configs\\core.cfg";
#endif
...
bool SM_ExecuteConfig(IPlugin *pl, AutoConfig *cfg, bool can_create)
{
	...
	if (!file_exists && will_create)
	{
		...
		if (pl->GetProperty("ConVarList", (void **)&convars, false) && convars)
		{
			...
			if (fp)
			{
				fprintf(fp, "// This file was auto-generated by Source2Mod (v%s)\n", SOURCEMOD_VERSION);
...
void SM_ExecuteAllConfigs()
{
	...
	engine->ServerCommand("exec source2mod/source2mod.cfg\n");
